...
# Get user_id from user json object returned in response
def get_user_id_from_user_json(raw_tweet_json):
    return raw_tweet_json['data']['id']
...
def get_parsed_users_from_raw_json(raw_user_json):
    ...
    with open(debug_dir + 'timeline-'+today_str+'_raw_users.json', 'w') as file:
